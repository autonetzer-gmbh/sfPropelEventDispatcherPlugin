...
class RegisterEventListenersPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $container->setParameter('propel_event_dispatcher.registered_classes', $this->classes);
    }
    ...
    private function getDispatcherForClass(ContainerBuilder $container, $class)
    {
        ...
        $service = $container
            ->register($id)
            ->setClass('%propel_event_dispatcher.event_dispatcher.class%')
    ...
    {
        return 'propel_event_dispatcher.dispatcher.' . strtolower(str_replace('\\', '_', $class));
    }
}
